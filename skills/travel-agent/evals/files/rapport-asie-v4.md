# Rapport Asie v4 — livraison L3b

Arrêté : **2026-09-24T10:52:46+00:00**. Produit avec **travel-agent v1.3.0**, sept phases, à partir du rapport v3 corrigé après `359fd49` et des traces du commit **9a86f20a295d88f962c1f8c9e1d0afbbc314c35b**, branche `claude/travel-agent-skill-setup-vhqmwf`. Run complémentaire **35983276350** : 14 réponses et 2 schémas, horodatés le 24/09/2026. Aucun appel Kiwi/Trivago supplémentaire, aucune réservation.
...
|---|---|---|
| 1 chambre double, sans besoin d’accessibilité signalé | Occupation de recherche ; âge exact inconnu | Lit, mobilité, âge pour assurance |
...
**Lecture du budget :** les hôtels sont désormais chiffrés sur toute la durée, sans extrapolation. `S` désigne les postes chiffrés, `U` les coûts restants réellement non bornés (assurance, activités, taxes/frais non confirmés, acheminement domicile↔BRU). Total = `S + réserve + U`. Les trois états restent **non concluants** tant que U n’est pas borné : une marge disponible ne prouve pas le prix de ces postes. ✅ n’est utilisé que pour un contrôle établi, jamais pour un poste non applicable ; les offres partielles restent ⚠️.

## Synthèse A/B/C et recommandation

| Option / hôtel unique | Dates locales et nuits / départ BRU / retour BRU | Total chiffré + réserve, groupe (par personne) | Écart au plafond après U | État / plage / transferts |
|---|---|---|---|---|
| **A Nai Yang — Naiyang Beach Hotel** | 2026-11-30→2026-12-16 ; 16 nuits / 2026-11-29 / 2026-12-17 | ⚠️ 3 291,80 €–4 292,15 € + U ; (1 645,90 €–2 146,07 € + U/2) | 3 707,85 € − U_haut | **Non concluant** ; 3,5/5 ; 2 accès aéroport, 0 changement d’étape |
| **B Ao Nang — Anyavee Ao Nang Bay Resort** | 2026-12-02→2026-12-20 ; 18 nuits / 2026-12-01 / 2026-12-20 | ⚠️ 4 794,85 €–5 905,75 € + U ; (2 397,42 €–2 952,88 € + U/2) | 2 094,25 € − U_haut | **Non concluant** ; 3,5/5 ; 2 accès aéroport, 0 changement d’étape |
| **C Khao Lak — Palm Galleria Resort** | 2026-11-30→2026-12-18 ; 18 nuits / 2026-11-29 / 2026-12-19 | ⚠️ 4 120,87 €–5 258,10 € + U ; (2 060,44 €–2 629,05 € + U/2) | 2 741,90 € − U_haut | **Non concluant** ; 4/5 ; 2 accès aéroport, 0 changement d’étape |

**Classement final des dossiers chiffrés : A, C, B**, à état budgétaire identique. A est le moins cher et limite la route ; C apporte deux nuits supplémentaires avec davantage de trajet terrestre et un retour aérien long ; B coûte plus cher dans le scénario repos retenu. Ce classement compare des durées différentes explicitement affichées ; il n’est ni une note objective ni un minimum global d’Asie.

**Recommandation : A, 16 nuits à Nai Yang**, départ BRU le 29/11, hôtel du 30/11 au 16/12, retour BRU le 17/12. La base conserve le minimum de prix documenté ; ses escales sont longues. Pour le rythme détente, la variante confort chiffrée ci-dessous remplace le vol et l’hôtel sans changer de lieu ou de dates : elle réduit la fatigue tout en laissant une capacité importante pour les postes manquants. Ne pas choisir automatiquement le 5★ le plus cher : les longues offres Dewa et The Slate ne reprennent pas les anciens petits séjours à bas prix.

Les notes plage reflètent proximité déclarée et type de séjour, pas une météo garantie. Nai Yang et Ao Nang ne valent pas une plage privée ; C favorise le repos dans un resort près de Pakarang. La catégorie officielle des hôtels reste à confirmer malgré les recoupements.

## Comparaison 16 / 17 / 18 nuits et billets

Les cinq lignes ci-dessous associent un hôtel **aux dates exactes d’arrivée et de départ**. Même hôtel Naiyang Beach Hotel pour isoler l’effet du calendrier ; 2 adultes, 1 chambre, BE/EUR, 2 soutes structurées. Les prix hôtel sont des séjours, pas des prix/nuit multipliés.

| Scénario | Hôtel exact / nuits | Vols groupe | Hôtel groupe | Vol+hôtel | Total chiffré avec repas, transferts A, réserve, hors U | Preuves |
|---|---|---:|---:|---:|---:|---|
| 16 nuits exactes | 2026-11-30→2026-12-16 ; 16 | ⚠️ 1 018,00 € | ⚠️ 771,00 € | 1 789,00 € | 3 291,80 €–4 292,15 € + U | Vol : `test-output-v3/kiwi_hkt_exact_16n.json` [0], 2026-09-24T09:48:23+00:00, [offre](https://kiwi.com/u/m9tfuy) ; hôtel : `test-output-v3/trivago_naiyang_16n.json` [9], 2026-09-24T09:48:11+00:00, [offre](https://www.trivago.be/en-US/lm/naiyang-beach-hotel-nai-yang-beach?cip=234716015&currencyCode=EUR&search=100-2722380;105-1320;105-1322;200-15960;dr-20261130-20261216;drs-40;rc-1-2&dealId=-4613757501875177488) |
| 17 nuits exactes | 2026-11-30→2026-12-17 ; 17 | ⚠️ 1 234,00 € | ⚠️ 819,00 € | 2 053,00 € | 3 584,76 €–4 643,02 € + U | Vol : `test-output-v3/kiwi_hkt_exact_17n.json` [0], 2026-09-24T09:48:26+00:00, [offre](https://kiwi.com/u/ry4uku) ; hôtel : `test-output-v3/trivago_naiyang_17n.json` [9], 2026-09-24T09:48:13+00:00, [offre](https://www.trivago.be/en-US/lm/naiyang-beach-hotel-nai-yang-beach?cip=234716015&currencyCode=EUR&search=100-2722380;105-1320;105-1322;200-15960;dr-20261130-20261217;drs-40;rc-1-2&dealId=-1217118755051191533) |
| 18 nuits AR | 2026-11-30→2026-12-18 ; 18 | ⚠️ 1 417,27 € | ⚠️ 868,00 € | 2 285,27 € | 3 845,99 €–4 962,16 € + U | Vol : `test-output-v3/kiwi_hkt_fenetre_18n.json` [5], 2026-09-24T09:48:45+00:00, [offre](https://kiwi.com/u/79rhus) ; hôtel : `test-output-v3/trivago_naiyang_18n.json` [8], 2026-09-24T09:48:15+00:00, [offre](https://www.trivago.be/en-US/lm/naiyang-beach-hotel-nai-yang-beach?cip=234716015&currencyCode=EUR&search=100-2722380;105-1320;105-1322;200-15960;dr-20261130-20261218;drs-40;rc-1-2&dealId=-2006501001029522391) |
...
|---|---|---|---|---|
| Retenu | Naiyang Beach Hotel ; 4★ déclarées ; 7.6/10, 1,878 avis | 2026-11-30→2026-12-16 | `€ 771` → **⚠️ 771,00 €** | Nai Yang Beach, 0.5 km to City center ; `test-output-v3/trivago_naiyang_16n.json` [9], 2026-09-24T09:48:11+00:00, [offre](https://www.trivago.be/en-US/lm/naiyang-beach-hotel-nai-yang-beach?cip=234716015&currencyCode=EUR&search=100-2722380;105-1320;105-1322;200-15960;dr-20261130-20261216;drs-40;rc-1-2&dealId=-4613757501875177488) ; annonceur Agoda |
| Plan B | Panphuree Residence ; 4★ déclarées ; 8.3/10, 6,451 avis | 2026-11-30→2026-12-16 | `€ 1.035` → **⚠️ 1 035,00 €** | Nai Yang Beach, 1.7 km to City center ; `test-output-v3/trivago_naiyang_16n.json` [4], 2026-09-24T09:48:11+00:00, [offre](https://www.trivago.be/en-US/lm/hotel-panphuree-residence-nai-yang-beach?cip=234716015&currencyCode=EUR&search=100-7128130;105-1320;105-1322;200-15960;dr-20261130-20261216;drs-40;rc-1-2&dealId=-1442023536548554602) ; annonceur Trip.com |
...
Naiyang Beach Hotel est le moins cher des hôtels 4–5★ présélectionnés dans la localité, sans alarme cumulée établie. Le classement 4★ est aussi affiché par [NAIYANG](https://www.google.com/travel/hotels/entity/ChcI4_HShYu09KkxGgsvZy8xdjlkNHdxdhAB), sans preuve de registre indépendant. Panphuree est le plan B, plus cher mais mieux noté. Le nom « Residence » ne signifie pas automatiquement appartement : chambre d’hôtel à confirmer. Confort : L’esprit, chambre de resort plutôt que villa indépendante, plus vol Etihad rapide décrit au registre.

#### Budget bas–haut du groupe

| Poste | Bas | Haut | Statut / méthode |
|---|---:|---:|---|
| Vols | 1 018,00 € | 1 018,00 € | ⚠️ Offres détaillées ci-dessus |
| Hôtel unique | 771,00 € | 771,00 € | ⚠️ price_per_stay exact ; taxes/conditions finales non confirmées |
| Liaisons inter-étapes | n/a | n/a | Aucune étape supplémentaire ; aucun prix inventé |
| Transferts A/R | 10,53 € | 26,32 € | ⚠️ Estimation sourcée TA, ci-dessous ; pas prix réservable |
| Repas, 17 jours | 492,27 € | 1 476,82 € | ⚠️ 2 adultes × jours × 550–1 650 THB / 37,987 ; source REPAS |
| Assurance | manquant | manquant | Source ASSURANCE sans prime adaptée, âge/résidence/couverture inconnus |
| Activités payantes | manquant | manquant | Programme de base libre ; sorties éventuelles non réputées gratuites |
| Formalités, taxes/frais non inclus, banque, domicile↔BRU | manquant | manquant | Aucun montant nul par défaut ; domicile inconnu |
| **Sous-total chiffré avant réserve S** | **2 291,80 €** | **3 292,15 €** | U exclu, pas tout compris |
| Réserve | 1 000,00 € | 1 000,00 € | Fixe, séparée, incluse sous le plafond |
| **Total** | **3 291,80 € + U_bas** | **4 292,15 € + U_haut** | **Non concluant** ; par personne total/2 |

Par personne : **1 645,90 € + U_bas/2 à 2 146,07 € + U_haut/2**. Écart haut au plafond : **3 707,85 € − U_haut**. Les frais manquants ne sont pas « absorbés » fictivement par la réserve.

**Variante confort : L'esprit De Naiyang Beach Resort - SHA Extra Plus**, avec AR Etihad du 29/11 au retour local 16/12, index 11 de `kiwi_hkt_exact_16n`. Total chiffré avec réserve : **4 885,08 €–5 885,42 € + U** ; par personne **2 442,54 €–2 942,71 € + U/2**. Reste sous plafond **si U_haut ≤ 2 114,58 €**. Ce seuil est une condition explicite, pas une prime d’assurance ou un prix d’activités. Transfert vers l’hôtel de remplacement reste un proxy régional et doit être confirmé. Ne pas cumuler hôtel principal et confort.
...
Plan B budget : rester dans le même lieu, choisir le plan B aux mêmes dates seulement après confirmation du prix final. Ne pas relancer les vols pour un simple remplacement d’hôtel. Si prix final ou disponibilité change la date, recalculer l’ensemble des postes dépendants.
...
| Poste | Bas | Haut | Statut / méthode |
|---|---:|---:|---|
| Vols | 1 804,27 € | 1 804,27 € | ⚠️ Offres détaillées ci-dessus |
| Hôtel unique | 1 393,00 € | 1 393,00 € | ⚠️ price_per_stay exact ; taxes/conditions finales non confirmées |
| Liaisons inter-étapes | n/a | n/a | Aucune étape supplémentaire ; aucun prix inventé |
| Transferts A/R | 47,38 € | 57,91 € | ⚠️ Estimation sourcée TB, ci-dessous ; pas prix réservable |
| Repas, 19 jours | 550,19 € | 1 650,56 € | ⚠️ 2 adultes × jours × 550–1 650 THB / 37,987 ; source REPAS |
| Assurance | manquant | manquant | Source ASSURANCE sans prime adaptée, âge/résidence/couverture inconnus |
| Activités payantes | manquant | manquant | Programme de base libre ; sorties éventuelles non réputées gratuites |
| Formalités, taxes/frais non inclus, banque, domicile↔BRU | manquant | manquant | Aucun montant nul par défaut ; domicile inconnu |
| **Sous-total chiffré avant réserve S** | **3 794,85 €** | **4 905,75 €** | U exclu, pas tout compris |
| Réserve | 1 000,00 € | 1 000,00 € | Fixe, séparée, incluse sous le plafond |
| **Total** | **4 794,85 € + U_bas** | **5 905,75 € + U_haut** | **Non concluant** ; par personne total/2 |

Par personne : **2 397,42 € + U_bas/2 à 2 952,88 € + U_haut/2**. Écart haut au plafond : **2 094,25 € − U_haut**. Les frais manquants ne sont pas « absorbés » fictivement par la réserve.

**Variante confort : Krabi Resort**, avec mêmes vols B. Total chiffré avec réserve : **5 291,85 €–6 402,75 € + U** ; par personne **2 645,92 €–3 201,38 € + U/2**. Reste sous plafond **si U_haut ≤ 1 597,25 €**. Ce seuil est une condition explicite, pas une prime d’assurance ou un prix d’activités. Transfert vers l’hôtel de remplacement reste un proxy régional et doit être confirmé. Ne pas cumuler hôtel principal et confort.
Plan B budget : rester dans le même lieu, choisir le plan B aux mêmes dates seulement après confirmation du prix final. Ne pas relancer les vols pour un simple remplacement d’hôtel. Si prix final ou disponibilité change la date, recalculer l’ensemble des postes dépendants.
...
| Poste | Bas | Haut | Statut / méthode |
|---|---:|---:|---|
| Vols | 1 302,00 € | 1 302,00 € | ⚠️ Offres détaillées ci-dessus |
| Hôtel unique | 1 116,00 € | 1 116,00 € | ⚠️ price_per_stay exact ; taxes/conditions finales non confirmées |
| Liaisons inter-étapes | n/a | n/a | Aucune étape supplémentaire ; aucun prix inventé |
| Transferts A/R | 152,68 € | 189,54 € | ⚠️ Estimation sourcée TC, ci-dessous ; pas prix réservable |
| Repas, 19 jours | 550,19 € | 1 650,56 € | ⚠️ 2 adultes × jours × 550–1 650 THB / 37,987 ; source REPAS |
| Assurance | manquant | manquant | Source ASSURANCE sans prime adaptée, âge/résidence/couverture inconnus |
| Activités payantes | manquant | manquant | Programme de base libre ; sorties éventuelles non réputées gratuites |
| Formalités, taxes/frais non inclus, banque, domicile↔BRU | manquant | manquant | Aucun montant nul par défaut ; domicile inconnu |
| **Sous-total chiffré avant réserve S** | **3 120,87 €** | **4 258,10 €** | U exclu, pas tout compris |
| Réserve | 1 000,00 € | 1 000,00 € | Fixe, séparée, incluse sous le plafond |
| **Total** | **4 120,87 € + U_bas** | **5 258,10 € + U_haut** | **Non concluant** ; par personne total/2 |

Par personne : **2 060,44 € + U_bas/2 à 2 629,05 € + U_haut/2**. Écart haut au plafond : **2 741,90 € − U_haut**. Les frais manquants ne sont pas « absorbés » fictivement par la réserve.

**Variante confort : Apsara Beachfront Resort & Villa**, avec AR Etihad index 5 de `kiwi_hkt_fenetre_18n`, au lieu des deux simples. Total chiffré avec réserve : **4 830,15 €–5 967,38 € + U** ; par personne **2 415,07 €–2 983,69 € + U/2**. Reste sous plafond **si U_haut ≤ 2 032,62 €**. Ce seuil est une condition explicite, pas une prime d’assurance ou un prix d’activités. Transfert vers l’hôtel de remplacement reste un proxy régional et doit être confirmé. Ne pas cumuler hôtel principal et confort.
...
- Naiyang Beach : 48,19 €/nuit, 1 878 avis, 7,6 ; piscine/restaurant : aucun cumul établi.
...
Aucun certificat de classement thaïlandais n’a été obtenu. « Pas d’alarme cumulée » ne signifie pas « étoiles certifiées ». Les plans B doivent également être confirmés au panier : type de chambre, lit, taxes, repas, paiement et annulation. Aucun petit déjeuner n’est déduit du budget.
...
## Itinéraire détente et plans B

Maximum deux activités par jour, sans obligation de remplir les journées. A = 16 nuits ; B/C = 18 nuits. Aucun changement d’hôtel.

| Jours locaux | A — Nai Yang | B — Ao Nang | C — Khao Lak | Plan B |
|---|---|---|---|---|
| J1, arrivée | Transfert, dépôt bagages, repos | Idem, chambre matinale non garantie | Idem | Piscine/repos lorsque chambre disponible |
| J2–J4 | Plage et courte promenade | Plage et promenade locale | Plage et piscine | Repos couvert ; pas de sortie en mer imposée |
| J5–J8 | Une demi-journée culturelle facultative, journées libres | Une excursion côtière facultative, journées libres | Une visite locale facultative, journées libres | Annuler/remplacer la sortie météo défavorable |
| J9–J12 | Plage, repos, promenade au choix | Idem | Idem | Activité intérieure à chiffrer si souhaitée |
| J13–J16 | Journées libres ; préparer le départ | Journées libres | Journées libres | Conserver le même hôtel |
| J17 | Départ local A le 16/12 | Journée libre | Journée libre | Marge bagages et trajet |
| J18 | — | Journée libre | Journée libre | Repos |
| J19 | — | Départ local le 20/12 | Départ local le 18/12, matinal | Transfert confirmé la veille |

Les activités facultatives payantes restent « manquant » jusqu’au choix et au devis. Marcher ou se reposer n’autorise pas à inscrire zéro pour toutes les activités du voyage. Les éventuelles entrées de parc et transports locaux ne sont pas réputés inclus.
...
Les champs de chambre, taxes, pension, annulation et paiement ne sont pas complètement exposés. Un prix fournisseur reste une offre partielle même si extraction et addition sont vérifiées. Les hôtels ne sont jamais extrapolés depuis un court séjour. Les montants de transport terrestre et nourriture sont des estimations explicitement sourcées, les autres coûts non bornés restent manquants. Les plafonds régionaux d’étoiles et marges de temps sont des heuristiques, pas des garanties.

### Requêtes et vérifications encore nécessaires

Aucun nouvel appel Kiwi/Trivago indispensable à la construction des trois scénarios documentés : leurs hôtels sont maintenant couverts aux dates exactes. Un élargissement aux minima tardifs 17/18 nuits nécessiterait de nouveaux devis hôtel ; il n’est pas réalisé et n’est pas nécessaire pour appeler A « moins cher parmi les scénarios complets reçus ». Les conditions finales, poids des bagages, transferts, assurance, activités, taxes et domicile↔BRU doivent être confirmés avant tout engagement. La réserve ne remplace pas cette vérification. Aucun appel supplémentaire lancé.

## Écarts du skill

| Exigence / constat | Écart observé | Correction proposée, non appliquée au skill |
|---|---|---|
| Balayer dates × destinations | 15 résultats limités ; exact moins cher que fenêtre | Documenter couverture et provenance, ne jamais promettre optimum global |
| Open-jaw | Deux simples BRU/HKT ne changent pas d’aéroport | Distinguer achat séparé et véritable open-jaw ; comparer la fatigue |
| Une seule étape | Recommandation initiale multi-étapes devenue contraire au besoin | L’entrée utilisateur prime ; aucun circuit imposé |
| Bagages / billet protégé | Écho et nombres présents, poids/protection finale non prouvés | Conserver ⚠️ tant que panier et conditions ne sont pas relus |
| Zone | Certains champs mesurent visiblement un autre centre | Appliquer ici exclusion >10 km demandée ; proposer ultérieurement preuve géographique, jamais correction silencieuse |
| Étoiles | Aucun certificat ; Snapper n’a qu’un signal mécanique | Distinguer drapeau automatique ≥2 signaux et dérogation conservatrice motivée |
| Prix hôtel | Chaînes entières avec points de milliers | Parser avant somme, jamais traiter 1.035 comme 1,035 € |
| Budget tout compris | Assurance/activités/frais non bornés | Total S+1 000+U, état non concluant, pas de zéro fictif |
| Météo datée | Voyage hors horizon de prévision | Climat daté et contrôle météo proche départ |
| Triangulation | Certains tarifs/proxies et exemption thaïlandaise source unique | Marquer leur statut et confirmer avant engagement |
| Replanification sélective | Confort change hôtel/vol sans changer dates | Remplacer les postes, ne pas les cumuler, ne pas relancer tous les outils |

## Contrôle avant livraison

- [x] Hypothèses présentes ; trois options distinctes, un hôtel et un lieu chacune.
- [x] Nuits recomptées depuis arrivée/départ ; horaires locaux et dates BRU distingués.
- [x] Prix par séjour parsés ; paramètres, fichier, index, UTC et lien fournis.
- [x] BRU, adultes et bagages contrôlés dans les offres retenues ; limites contractuelles signalées.
- [x] Totaux recalculés sans arrondi intermédiaire ; réserve distincte ; U visible.
- [x] Zone et étoiles contrôlées ; plans B et variante confort présents.
- [x] Aucun nouvel appel Kiwi/Trivago, aucune réservation, aucun fichier générique modifié.
- [x] Écarts et requêtes non couvertes consignés ; aucune fausse certification « tout compris ».


**Change :** 1 EUR = 37,987 THB, taux de référence BCE via Frankfurter, date effective 23/09/2026 ; lecture conservée du 24/09/2026 09:00:33–09:00:36 UTC. Conversion THB ÷ 37,987, sans marge bancaire implicite. Les frais de change réels restent dans U.
